...
//TODO: receive length may be much longer
const double RECV_SEC = 0.2; 

const size_t SC_LEN	= 64;
const size_t CP_LEN	= 16;
const size_t SYM_LEN = SC_LEN + CP_LEN;

// Ensure at least receiving one batch of 500 symbols for offline decoding
const size_t NUM_SYMS = 500;
